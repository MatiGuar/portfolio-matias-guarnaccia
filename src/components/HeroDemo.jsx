  ...
  return (
    <section>
      <Hero
        ...
        cta1={{ label: "Descargar CV", href: "/portfolio-matias-guarnaccia/Cv_Matias_Guarnaccia.pdf", download: true }}
        cta2={{ label: "Ver CV online", href: "/portfolio-matias-guarnaccia/Cv_Matias_Guarnaccia.pdf" }}
      />
    </section>
  );
}
